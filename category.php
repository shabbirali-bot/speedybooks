                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete_category.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are You Sure You Want To Delete This?')" class="label label-important "> <i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
